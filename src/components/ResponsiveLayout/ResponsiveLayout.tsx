...
export class ResponsiveLayout extends React.PureComponent<ResponsiveLayoutProps> {
	...
	componentWillMount() {
		...
		this.XSComponent =
			typeof this.props.xs === 'string' ? getComponent(typeof this.props.xs) : this.props.xs;

		this.SMComponent =
			typeof this.props.sm === 'string' ? getComponent(typeof this.props.sm) : this.props.sm;

		this.MDComponent =
			typeof this.props.md === 'string' ? getComponent(typeof this.props.md) : this.props.md;

		this.LGComponent =
			typeof this.props.lg === 'string' ? getComponent(typeof this.props.lg) : this.props.lg;

		this.XLComponent =
			typeof this.props.xl === 'string' ? getComponent(typeof this.props.xl) : this.props.xl;
	}
		...
		return (
			<ScreenSizeObserver>
				{(screenSize: SCREEN_SIZE) => {
					...
					switch (screenSize) {
						case 'xs':
							return React.createElement(this.XSComponent || this.DefaultComponent, {
								...rest,
								...xsProps,
							});

						case 'sm':
							return React.createElement(this.SMComponent || this.DefaultComponent, {
								...rest,
								...smProps,
							});

						case 'md':
							return React.createElement(this.MDComponent || this.DefaultComponent, {
								...rest,
								...mdProps,
							});

						case 'lg':
							return React.createElement(this.LGComponent || this.DefaultComponent, {
								...rest,
								...lgProps,
							});

						case 'xl':
							return React.createElement(this.XLComponent || this.DefaultComponent, {
								...rest,
								...xlProps,
							});
